...
function libraryHTML(){
  ...
  const kick=lang==='ar'?`<div class="kick">صيدلية مستشفى سِناو · الجمعية الصيدلانية</div>`:`<div class="kick">Sinaw Pharmaceutical Society <span class="ar">·  صيدلية مستشفى سِناو</span></div>`;

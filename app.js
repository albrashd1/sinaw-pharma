...
const T={
  en:{
    ...
    waSub:'New topics added regularly — stay informed',
    ...
    sugPlMsg:'e.g. I\'d love to see a section on paediatric dosing… / The library is great but I noticed…',
    adminSugTitle:'Messages & Suggestions',
  ...
  ar:{
    ...
    waSub:'مواضيع جديدة تُضاف باستمرار — ابقَ على اطّلاع',
    ...
    sugPlName:'مثال: هيثم',
    sugPlEmail:'your@email.com',
    sugPlMsg:'مثال: أودّ رؤية قسم عن جرعات الأطفال… / المكتبة رائعة لكن لاحظت…',
    adminSugTitle:'الرسائل والاقتراحات',
